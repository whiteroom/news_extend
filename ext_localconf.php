...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('<INCLUDE_TYPOSCRIPT: source="DIR:EXT:news_extend/Configuration/TSconfig/Ext/News" extensions="t3s">');
